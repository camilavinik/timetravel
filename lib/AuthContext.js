 ...
 * 
 * Provides authentication state management, user registration, login/logout functionality,
 * and profile management using Supabase. Handles session persistence and auto-refresh
 * for seamless user experience across app state changes.
 * 
 * @param {Object} children - React components to be wrapped by AuthProvider
 * @returns {Object} AuthProvider component and useAuthContext hook
 */
